...
class EmployerListViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "Employers"
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        var cell: UITableViewCell! = tableView.dequeueReusableCellWithIdentifier("employer", forIndexPath: indexPath)

        if cell == nil {
            cell = UITableViewCell(style: .Default, reuseIdentifier: "employer")
        }
    ...
    */
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        if self.module == Module.BOOKMARK && editingStyle == .Delete {
